...
func TestConvertFirmwareRuleToIpRuleBeanAddFirmareConfig(t *testing.T) {
	...
	ipRuleBean := coreef.ConvertFirmwareRuleToIpRuleBean(db.GetDefaultTenantId(), firmwareRule4)
...
func TestConvertFirmwareRuleToIpFilter(t *testing.T) {
	...
	ipFilter := coreef.ConvertFirmwareRuleToIpFilter(db.GetDefaultTenantId(), firmwareRule)
...
func TestIpFilterConverterConvertFirmwareRuleToIpFilterByMultipleRuleConditions(t *testing.T) {
	...
	err := shared.CreateGenericNamedListOneDB(db.GetDefaultTenantId(), ipListPtr)
	assert.NilError(t, err)
	...
	converted := coreef.ConvertFirmwareRuleToIpFilter(db.GetDefaultTenantId(), firmwareRuleConverted)
